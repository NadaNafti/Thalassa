...
class SaisonsController extends Controller
{
    ...
    public function listeAction(Hotel $hotel)
    {
        ...
        return $this->render('BackHotelTunisieBundle:Saisons:liste.html.twig', array('hotel' => $hotel, 'saisons' => $saisons,));
    }
    ...
    public function generalAction(Saison $saison)
    {
        ...
        return $this->render('BackHotelTunisieBundle:Saisons:general.html.twig', array('hotel' => $hotel, 'saison' => $saison, 'form' => $form->createView(),));
    }
    ...
    public function reductionAction(Saison $saison)
    {
        ...
        return $this->render('BackHotelTunisieBundle:Saisons:reductions.html.twig', array('hotel' => $saison->getHotel(), 'saison' => $saison, 'form' => $form->createView(),));
    }
    ...
    public function vueAction(Saison $saison)
    {
        ...
        return $this->render('BackHotelTunisieBundle:Saisons:vue.html.twig', array('hotel' => $hotel, 'saison' => $saison, 'form' => $form->createView(),));
    }
    ...
    public function autreSuppAction(Saison $saison, $id2)
    {
        ...
        return $this->render('BackHotelTunisieBundle:Saisons:autre_supp.html.twig', array('saison' => $saison, 'hotel' => $saison->getHotel(), 'form' => $form->createView(), 'saisonAutreSupp' => $saisonAutreSupp,));
    }
    ...
    public function deleteAutreSuppAction(SaisonAutreSupp $saisonAutreSupp)
    {
        ...
        return $this->redirect($this->generateUrl("AutreSuppSaison", array('id' => $saisonAutreSupp->getSaison()->getId(),)));
    }
    ...
    public function autreReducAction(Saison $saison, $id2)
    {
        ...
        return $this->render('BackHotelTunisieBundle:Saisons:autre_reduc.html.twig', array('saison' => $saison, 'hotel' => $saison->getHotel(), 'form' => $form->createView(), 'saisonAutreReduc' => $saisonAutreReduc,));
    }
    ...
    public function deleteAutreReducAction(SaisonAutreReduc $saisonAutreReduc)
    {
        ...
        return $this->redirect($this->generateUrl("AutreReducSaison", array('id' => $saisonAutreReduc->getSaison()->getId(),)));
    }

    public function prixAction(Saison $saison)
    {
        return $this->render('BackHotelTunisieBundle:Saisons:prix.html.twig', array('saison' => $saison, 'hotel' => $saison->getHotel(),));
    }

    public function recupAction(Saison $saison)
    {
        return $this->render('BackHotelTunisieBundle:Saisons:recup.html.twig', array('saison' => $saison,));
    }
